...
-   Understand what constitutes an embedded system.
-   Explore why Linux is integral to embedded systems.
-   Establish a roadmap for the course ahead.

## What Is an Embedded System?

An **embedded system** is a special-purpose computer designed to perform dedicated functions within a larger system, such as:
...
## Origins of "Embedded System"

The term originated in the 1960s–70s to describe computers embedded within larger electromechanical systems, notably:

-   Missile guidance systems (e.g., Minuteman I, 1962)
...
Every embedded system has two main components:

1.  **Application Software**
    -   Implements the specific functionalities of the device.
2.  **Platform (Hardware + Basic Software)**
    -   Provides foundational services for applications.
    -   Includes the operating system, device drivers, and system libraries.

## Why Linux?

Linux is a popular choice for embedded systems due to:

-   Open-source flexibility
-   Robustness and reliability
-   Extensive hardware support
-   A large supporting community and ecosystem

## Key Milestones in Linux Development

-   **1991**: Linux announced by Linus Torvalds.
-   **1994**: Linux 1.0 released.
-   **2003**: Linux 2.6 scalability improvements.
-   **2011–present**: Continuous enhancements for embedded and server environments.

## Linux Kernel and User Space

-   **Kernel**: Core of Linux, managing resources, processes, and hardware.
-   **User Space**: Runs applications isolated from the kernel, ensuring stability.

## Linux Distributions

Bundles kernel with system tools, examples include:

-   **General-purpose**: Ubuntu, Fedora
-   **Embedded-specific**: Yocto, Buildroot, OpenWrt

## Choosing a Linux Distribution

Consider:

-   Hardware support (e.g., ARM, x86, RISC-V)
-   Community vs. commercial support
-   Minimal vs. full-featured distributions
-   Long-term stability and security updates

## Examples of Linux-Based Embedded Systems

-   In-flight entertainment systems
-   Retail Point-of-Sale systems (e.g., Tim Hortons)
-   Gas station pumps (mission-critical reliability)

## Review Questions

1.  **What is an embedded system?**\
    *A dedicated-purpose computer within a larger device.*

2.  **Why use Linux in embedded systems?**\
    *Flexibility, reliability, hardware support, and extensive ecosystem.*
